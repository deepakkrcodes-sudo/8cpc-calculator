...
const blogData = [
  ...
  {
    id: 3,
    slug: "expected-fitment-factor-8th-cpc",
    title: "Expected Fitment Factor in 8th CPC – Realistic Analysis",
    category: "salary",
    date: "April 2026",
    readTime: "8 min read",
    image:
    ...
    excerpt:
      "Explore possible fitment factors (2.57 to 3.0+) and their actual salary impact with practical scenarios.",
  },
  {
    id: 4,
      ...
      <div className="text-center space-y-4">
        <h1 className="text-xl md:text-2xl font-semibold tracking-tight">
          <span className="bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
            8th CPC Blog – In-depth Guides & Analysis
          </span>
        </h1>

        <p className="text-xs md:text-sm text-gray-600 max-w-3xl mx-auto">
          Detailed explanations, salary insights, and expert analysis to help you understand the 8th Pay Commission clearly.
        </p>
