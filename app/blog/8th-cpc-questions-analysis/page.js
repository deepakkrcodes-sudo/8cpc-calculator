        ...
        {questionsDeepDive.map((item) => (
          <div key={item.q} className="rounded-xl border border-gray-200 p-5 shadow-sm space-y-3">
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-3">
              <div className="text-xs font-semibold text-indigo-700">What it means</div>
              <p className="text-sm text-gray-700 mt-1 leading-relaxed">{item.analysis}</p>
            </div>

            <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-3">
              <div className="text-xs font-semibold text-yellow-700">What it reveals</div>
              <p className="text-sm text-gray-700 mt-1 leading-relaxed">{item.reveal}</p>
            </div>
